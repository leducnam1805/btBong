...
public class AdminEditQuyenController extends HttpServlet {
	private static final long serialVersionUID = 1L;

	public AdminEditQuyenController() {
		super();
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		CatUser catUser = new CatUser(cuid, true, editquyen, true);
		int edit = catUserDao.editquyen(catUser);
		if(edit > 0) {
