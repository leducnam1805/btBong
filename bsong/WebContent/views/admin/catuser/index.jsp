                    			...
                    			<div class="table-responsive">
		                            ...
		                            <%
		                            	if(checkUser.getCatUser().isAddquyen() == true){
		                            		%>
		                            			<div class="col-sm-6">
				                                    <a href="<%=request.getContextPath()%>/admin/catuser/add" class="btn btn-success btn-md">Thêm</a>
				                                </div>
		                            		<%
		                            	}
		                            %>
			    				                                       ...
			    				                                       <%
											                            ...
											                            <%
											                            	if(checkUser.getCatUser().isDelquyen() == true){
											                            		%>
											                            			<a idCatUser=<%=id %> title="" class="btn btn-danger del-catuser"><i class="fa fa-pencil"></i> Xóa</a>
											                            		<%
											                            	}
											                            %>
			    				                                        </td>
...
<script>
    document.getElementById("catuser").classList.add('active-menu');
</script>
<script>
    document.getElementById("usermanager").classList.add('active-menu');
</script>
<script>
        $(document).on("click", "a.del-catuser", (function () {
        	//lấy dữ liêu
    	        ...
    	        customClass: null
    	    	  ...
    	    	  if (result.value) {
    	    		  $.ajax({
    	    			  	async: false,
    	    	            type: "get",
    	    	            url: "<%=request.getContextPath()%>/admin/catuser/del",
    	    	            data: { id : id },
